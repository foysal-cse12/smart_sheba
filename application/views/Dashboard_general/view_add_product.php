         ...
         <div class="row back">
            ...
            <div class="col-md-12 main">
               <div class="main-login main-center">
                ...
                <form class="form-horizontal" method="post" enctype="multipart/form-data" action="/smart_sheba/home/add_product_details_general"> 
                  ...
                  <!-- <?php echo form_open_multipart('home/add_product_details/'); ?> -->
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-md-9">
                           <div class="input-group">
                              ...
                              <input type="text" class="form-control" name="pr_previous_price"  value='<?php echo set_value("pr_previous_price");?>' id="preice"  placeholder="Enter your Previous Price"/>
                           </div>
                        </div>
                     </div>       
                     <div class="text-center wrong">
                     ...
                     <!-- <div class="form-group">
                        ...
                        <div class="col-md-9">
                           <div class="input-group">
                              ...
                              <input type="text" class="form-control"  name="pr_discount"  value='<?php echo set_value("pr_discount");?>' id="discount" placeholder="Enter your Discount in percentage"> 
                           </div>
                        </div>
                     </div>
                     <div class="text-center wrong">
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-md-9">
                           <div class="input-group">
                              <span class="input-group-addon"><i class="fa fa-ticket" aria-hidden="true"></i></span>
                              <input type="text" class="form-control" name="pr_price"  value='<?php echo set_value("pr_price");?>' id="preice"  placeholder="Enter your current Price"/>
                           </div>
                        </div>
                     </div>       
                     <div class="text-center wrong">
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-md-9">
                           <div class="input-group">
                              <span class="input-group-addon"><i class="fa fa-ticket" aria-hidden="true"></i></span>
                              <input type="text" class="form-control" name="pr_commission"  value='<?php echo set_value("pr_commission");?>' id="preice"  placeholder="Smartsheba commission in percentage"/>
                           </div>
                        </div>
                     </div>       
                     <div class="text-center wrong">
