         ...
         <div id="loginbox" class="mainbox col-md-6 col-md-offset-3 col-sm-6 col-sm-offset-3">
            ...
            <div class="panel" >
               <div class="panel-body" >
                  <div class="panel-title text-center">Create Account Using Facebook</div>
                  <form name="form" id="form" class="form-horizontal" action="/smart_sheba/home/registration_data_via_fb" method="post">
					...
					<div class="input-group">
								...
								<input id="user" type="text" class="form-control" name="fullname" value="<?php echo $name;?>" placeholder="Your Full Name...">                                        
							</div>
							<div class="text-center wrong">
          ...
          <div class="input-group">
                <span class="input-group-addon"><i class="fa fa-location-arrow"></i></span>
                <input id="user" type="text" class="form-control" name="parmanent_address" value="<?php echo set_value('parmanent_address');?>" placeholder="Your Parmanent Address..." required>                                        
          </div>
          <div class="text-center wrong">
               <span  ><?php echo form_error('parmanent_address'); ?></span>
          </div>
          ...
          <div class="input-group">
                ...
                <input id="user" type="text" class="form-control" name="social_links" value="<?php echo set_value('social_links');?>" placeholder="Your Social Link address..." >                                        
          </div>
          <div class="text-center wrong">
               <span  ><?php echo form_error('social_links'); ?></span>
          </div>
              ...
              <div class="input-group">
                        ...
                        <input id="envelope"  class="form-control" type="email" name="email" value="<?php echo $email;?>" placeholder="Your  Email...">                                        
                     </div>
                     <div class="text-center wrong">
