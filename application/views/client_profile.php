...
<html lang="en">
   ...
   <body>
      ...
      <div class="container nav_margin1">
         <div class="row">
            <div class="add-box">
               <img class="img-responsive" src="<?php echo base_url();?>images/GP-Go-Beyond_i.jpg" alt="Add" style="margin: 0px auto;"">
            </div>
         </div>
         <br/>
      </div>
            ...
            <div class="row">
                <div class="col-md-3 col-sm-3">                 
                    <div class="user-wrapper">
                        <img src="<?php echo base_url();?>assets/profile_images/{image}" class="img-responsive" style="margin: 0px auto;width:150px;height:150px;" /> 
                        <div class="description">
                         <center><h4>{fullname}</h4></center>
                          <center><h5> <strong>{work_history}</strong></h5></center>
                             ...
                             <div class="col-md-5">
                               ...
                               <div class="form-group">
                                   <div class="input-group">
                                       ...
                                       <input type="text" class="form-control"  placeholder="Describe Adderess here..."  name="address" value="{address}"  style="height:60px;"/>
                                   </div>
                               </div>
