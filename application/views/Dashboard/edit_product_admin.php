   ...
   <body>
     <!--   -->
      ...
      <div class="container">
         ...
         <div class="row back">
            <div class="wrapper">
               <div class="clip-text clip-text_one">Edit Product</div>
            </div>
            <div class="col-md-12 main">
               <div class="main-login main-center">
           
                
                <form class="form-horizontal" method="post" enctype="multipart/form-data" action="/smart_sheba/home/edit_product_details_client"> 
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-md-9">
                           <div class="input-group">
                              ...
                              <input type="text" class="form-control"  name="pr_previous_price"  value={pr_previous_price} id="discount" placeholder="Enter your Discount" > 
                           </div>
                        </div>
                     </div>
                     <div class="text-center wrong">
