		...
		<br/>
			<div class="container">
				...
				<div class="row cart-body">
					<form class="form-horizontal" method="post" action="/smart_sheba/home/product_order_data_client">
						...
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 col-md-pull-6 col-sm-pull-6">
							...
							<div class="panel panel-info">
								...
								<div class="panel-body">
									...
									<div class="form-group">
										<div class="col-md-12"><input type="hidden" name="pr_title" class="form-control" value="{pr_title}"/></div>
									</div>
