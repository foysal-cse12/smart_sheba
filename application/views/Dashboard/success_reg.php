    ...
    <br><br><br><br><br><br><br><br><br><br>
      <div class="container">
         <div class="row back well">
            ...
            <br/>
            <p class="text-center title">Your account will be activate within 24 hours</p><br/>
            <a href="<?php echo base_url();?>home/login" class="btn btn-info pull-right">Go to SignIn </a>
         </div>
         <br/>
      </div><br><br><br><br>
