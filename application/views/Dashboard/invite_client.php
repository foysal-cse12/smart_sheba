                      ...
                      <div class="panel-body">
                        ...
                        <div class="col-md-5 col-xs-8 details">
                          ...
                          <div class="col-md-4 col-xs-12 action text-center">
                            <a href="<?php echo base_url();?>home/view_profile/{id}" class="btn btn-info btn-sm ">View Profile</a>
                            <a href="<?php echo base_url();?>home/invite_friend_request/{id}" class="btn btn-info btn-sm">Add Friend</a>
                          </div>
                  </div>
                </div>
              </div>
