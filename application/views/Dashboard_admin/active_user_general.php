                     ...
                     <tbody>
                      {list}
                        <tr>
                           ...
                           <td>{date}</td>
                           <td>{mobile}</td>
                           <td><a href="/smart_sheba/home/view_profile_admin/{id}" class="btn btn-primary btn-xs" >View Peofile</a></td>
                           <td>Active</td>
                          <!-- <td><button class="btn btn-primary btn-xs" data-title="edit" ><span class="glyphicon glyphicon-pencil"></span></button></td>-->
                           <td><button class="btn btn-danger btn-xs" data-title="Delete" onclick="location.href='/smart_sheba/home/delete_user_general/{id}';" ><span class="glyphicon glyphicon-trash"></span></button></td>
                        </tr>
                      {/list}
                     </tbody> 
                  </table>
