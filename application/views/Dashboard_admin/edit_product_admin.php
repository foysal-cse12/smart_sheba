         ...
         <div class="row back">
            ...
            <div class="col-md-12 main">
               <div class="main-login main-center">
                ...
                <form class="form-horizontal" method="post" enctype="multipart/form-data" action="/smart_sheba/home/edit_product_details_admin"> 
                  ...
                  <!-- <?php echo form_open_multipart('home/add_product_details/'); ?> -->
                     ...
                     <div class="form-group">
                        <label for="discount" class="col-md-3 control-label">Privious Price</label>
                        <div class="col-md-9">
                           <div class="input-group">
                              <span class="input-group-addon"><i class="fa fa-cart-arrow-down" aria-hidden="true"></i></span>
                              <input type="text" class="form-control"  name="pr_previous_price"  value={pr_previous_price} id="discount" placeholder="Enter Previous Price"> 
                           </div>
                        </div>
                     </div>
                     <div class="text-center wrong">
