...
<html lang='en'>
   <head>
      ...
      <title>Smartsheba | Active Post Product</title>
                     ...
                     <tbody>
                      {list}
                        <tr>
                           ...
                           <td>{date}</td>
                           <td>{pr_details}</td>
                           <td><a href="<?php echo base_url();?>home/active_product_details_admin/{id}" class="btn btn-primary btn-xs" >View Details</a></td>
                           <td><button class="btn btn-primary btn-xs" data-title="Edit" ><span class="glyphicon glyphicon-pencil"></span></button></td>
                           <td><button class="btn btn-danger btn-xs" data-title="Delete"  onclick="location.href='/smart_sheba/home/delete_product/{id}';"><span class="glyphicon glyphicon-trash"></span></button></td>
                        </tr>
