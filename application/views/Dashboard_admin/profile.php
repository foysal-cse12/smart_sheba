         ...
         <div class="container">  
            <div class="row">
                <div class="col-md-3 col-sm-3">                 
                    <div class="user-wrapper">
                        ...
                        <div class="description">
                          ...
                          <a href="<?php echo base_url();?>home/change_password_admin" class="btn btn-info btn-lg"> <i class="fa fa-close" ></i> &nbsp;Change Password</a>
                        </div>
                     </div>
                </div>
                <div class="col-md-9 col-sm-9  user-wrapper">
                    ...
                    <form class="form form-signup" role="form" method="post" action="/smart_sheba/home/update_client_information_admin" enctype="multipart/form-data">
