                     ...
                     <tbody>
                      {list}
                        <tr>
                           ...
                           <td><a href="<?php echo base_url(); ?>home/edit_information_admin/{id}/{client_id}" class="btn btn-primary btn-xs" >Edit</a></td>
                          
                          <!-- <td><button class="btn btn-primary btn-xs" data-title="edit" ><span class="glyphicon glyphicon-pencil"></span></button></td>-->
                           <td><button class="btn btn-danger btn-xs" data-title="Delete" onclick="location.href='/smart_sheba/home/delete_information_admin/{id}/{client_id}';" ><span class="glyphicon glyphicon-trash"></span></button></td>
                        </tr>
                      {/list}
                     </tbody> 
                  </table>
