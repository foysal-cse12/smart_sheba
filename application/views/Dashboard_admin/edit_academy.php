   ...
   <body>
     <!--   -->
      ...
      <div class="container">
         ...
         <div class="row back">
            <div class="wrapper">
               <div class="clip-text clip-text_one">Edit Academy</div>
            </div>
            <div class="col-md-12 main">
               <div class="main-login main-center">
           
                
                <form class="form-horizontal" method="post" enctype="multipart/form-data" action="/smart_sheba/home/edit_academy_details_admin"> 
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-md-9">
                           <div class="input-group">
                              ...
                              <input type="text" class="form-control" name="academy_name" value='{academy_name}' id="title"  placeholder="Enter your academy name" required/>
                           </div>
                        </div>
                     </div>
                     ...
                     <div class="form-group">
                        <label for="discount" class="col-md-3 control-label">Academy Details</label>
                        <div class="col-md-9">
                           <div class="input-group">
                              <span class="input-group-addon"><i class="fa fa-cart-arrow-down" aria-hidden="true"></i></span>
                              <input type="text" class="form-control"  name="academy_details"  value="{academy_details}" id="discount" placeholder="Enter your academy details" > 
                           </div>
                        </div>
                     </div>
                     <div class="text-center wrong">
