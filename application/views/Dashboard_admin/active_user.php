                      ...
                      {list}
                        <tr>
                          ...
                          <!-- <td><button class="btn btn-primary btn-xs" data-title="edit" ><span class="glyphicon glyphicon-pencil"></span></button></td>-->
                           <td><button class="btn btn-danger btn-xs" data-title="Delete" onclick="location.href='/smart_sheba/home/delete_user/{id}';" ><span class="glyphicon glyphicon-trash"></span></button></td>
                        </tr>
                      {/list}
                     </tbody> 
                  </table>
