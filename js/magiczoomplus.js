/*
   ...
   Magic Zoom Plus v5.1.12 for MagicToolbox.com
...
window.MagicZoom = (function() {
    ...
    var t = function() {
        return "mgctlbxN$MZ" + "p".toUpperCase() + " mgctlbxV$" + "v5.1.12".replace("v", "") + " mgctlbxL$" + "m".toUpperCase() + ((window.mgctlbx$Pltm && "string" == A.jTypeOf(window.mgctlbx$Pltm)) ? " mgctlbxP$" + window.mgctlbx$Pltm.toLowerCase() : "")
    };
    ...
    v = {
        version: "v5.1.12 (Plus) for MagicToolbox.com",
        start: function(L, J) {
            var K = null,
                I = [];
